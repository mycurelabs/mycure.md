...
module.exports = configure(function (ctx) {
  return {
    ...
    pwa: {
      ...
      manifest: {
        name: 'Hippocrades.org',
        short_name: 'Hippocrades.org',
        description: 'Hippocrades provides a comprehensive decentralized healthcare infrastructure and protocol that unlock interoperability and security challenges among different health systems.',
        display: 'standalone',
