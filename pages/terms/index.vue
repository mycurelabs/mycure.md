    ...
    div.header.mb-5
      v-container
        v-row(align="center" :class="{'header-container': !$isMobile}")
          v-col(cols="12")
            h1(:class="headerClasses").text-center Terms and Conditions
    v-container
      v-row(justify="center" :class="descriptionClasses")
        generic-panel
          v-col(cols="12").mb-3
            strong Updated: July 02, 2020
            br
            br
            p These&nbsp;
              b Terms and Conditions&nbsp;
              | ("Terms", "Terms and Conditions") govern your relationship with&nbsp;
              strong.primary--text www.mycure.md&nbsp;
              | website and&nbsp;
              strong.primary--text MYCURE&nbsp;
              | mobile application (the "Service") operated by&nbsp;
              strong.primary--text MYCURE, Inc.&nbsp;
              | - USA and Team O.P.S. Inc. - Philippines ("us", "we", or "our").
          ...
          v-col(cols="12").mb-3
            ...
            p If you have any questions about these Terms,
              a
                strong(@click="toggleChat").toggle-chat.text-none.primary--text &nbsp;please contact us.
</template>
...
export default {
  ...
  head () {
    return headMeta({
      title: 'MYCURE Terms, Conditions and EULA Information',
      description: 'Learn more about our Terms and Conditions so you can maximize using MYCURE Clinic Management System in your practice. Last updated: February 21, 2018.',
