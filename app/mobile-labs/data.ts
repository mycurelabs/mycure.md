  ...
  items: [
    {
      ...
      description:
        "With MYCURE Maestro Technology (formerly Syncbase), work as if you have an in-house server with all cloud conveniences. Even if the Internet is down, you can still create records on any device.",
      icon: WifiOff,
    ...
    },
    {
      ...
      description:
        "Patient records on the move still need protection. MYCURE handles data with appropriate safeguards, controls who can see what, and connects with the systems your lab already uses.",
      icon: Shield,
