...
export const advantagesConfig: AdvantagesConfig = {
  ...
  items: [
    ...
    },
    {
      ...
      description:
        "Patient records on the move still need protection. MYCURE encrypts data at rest, gates access by role, and connects with the systems your lab already uses.",
      icon: Shield,
