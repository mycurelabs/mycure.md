...
export const metadata: Metadata = {
  ...
  description: "Streamline your clinic with MYCURE. Trusted by leading Philippine healthcare providers. HIPAA-aligned safeguards, works offline. Free trial.",
  keywords: [
    ...
    "clinic software Philippines",
        "HIPAA-aligned healthcare software",
    "patient management system",
    "medical practice management",
    "healthcare automation",
  ],
  authors: [{ name: "MYCURE", url: "https://mycure.md" }],
  creator: "MYCURE by Team OPS Inc.",
  publisher: "Team OPS Inc.",
  generator: null,
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    ...
    description: "Transform your healthcare practice with MYCURE. Trusted by leading Philippine healthcare providers. HIPAA-aligned safeguards, works offline.",
    images: [
      {
