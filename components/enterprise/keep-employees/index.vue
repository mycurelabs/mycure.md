  ...
  v-container.py-12.panel-keep-employees
    v-row(justify="center" align="center")
      v-col(cols="12" md="5" align-self="center" v-if="$isMobile").eightPanel-description
        ...
        p.font-18.mt-3.font-gray {{eightPanel.description}} <span class="font-18 font-weight-bold"><a class="font-gray" @click="goToFeatures">{{eightPanel.descriptionLink}}</a></span>
