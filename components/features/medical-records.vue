<template lang="pug">
  div
    div(v-if="!$isMobile").pt-5.panel-container
      v-container
        ...
        v-row(justify="center")
          carousel(
            ...
            slide(
              ...
              v-row(justify="center")
                img(:src="require(`~/assets/images/features/mycure-web-features-mockup-01-${feature}.png`)" alt="Medical records" height="200px")
</template>
