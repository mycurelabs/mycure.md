export const FEATURE_MODULE_GROUPS = [
  {
    ...
    modules: [
      {
        icon: 'MYCURE-virtual-clinic-healthcare-practice-online-features-J-core-01-medical-records.png',
        title: 'Medical Records',
        subTitle: 'Premium EMR designed for and by doctors',
      ...
      },
      {
        ...
        title: 'Telehealth',
        subTitle: 'Making quality healthcare accessible',
        description: 'A telemedicine platform for online video and audio consultations, interfaced with a patient portal for better access to medical records and forms.',
      },
      {
        icon: 'MYCURE-virtual-clinic-healthcare-practice-online-features-J-core-03-registration.png',
        title: 'Registration',
        subTitle: 'Streamlined registration process from start to finish',
      ...
      {
        icon: 'MYCURE-virtual-clinic-healthcare-practice-online-features-J-core-04-billing.png',
        title: 'Billing',
        subTitle: 'Simplified billing with beautiful reports',
      ...
      },
      {
        ...
        subTitle: 'Better operations with data-driven business decisions.',
  ...
  },
  {
    ...
    modules: [
      ...
      },
      {
        ...
        title: 'Imaging',
        subTitle: 'Interpret imaging results\nin an instant',
      ...
      },
      {
        ...
        subTitle: 'Monitor groups of\nPME patients effectively',
