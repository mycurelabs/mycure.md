...
// Base styles without animation (for reduced motion)
...
// Animation classes added when motion is allowed
const rainbowButtonAnimated = "transition-all animate-rainbow";

const rainbowButtonVariants = cva(rainbowButtonBase, {
  variants: {
    variant: {
      default:
    ...
    return (
      <Comp
        ...
        className={cn(
          ...
          // Add animation classes only when motion is allowed
          !prefersReducedMotion && rainbowButtonAnimated,
          !prefersReducedMotion && "before:animate-rainbow",
          className,
        )}
        ref={ref}
        {...props}
