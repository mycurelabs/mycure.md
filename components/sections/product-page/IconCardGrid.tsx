...
import type { IconCardGridConfig } from "@/components/types/product-page"

interface IconCardGridProps {
  config: IconCardGridConfig
}

export function IconCardGrid({ config }: IconCardGridProps) {
  return (
    <section id={config.sectionId} className="w-full py-12 sm:py-16 md:py-20 lg:py-32 bg-muted/30">
