        ...
        <div className="sm:hidden">
          ...
          <div className="mb-8">
            <div className="space-y-4">
              ...
              <div className="flex -ml-2">
                <Link href="https://www.facebook.com/mycure.md/" aria-label="MYCURE on Facebook" className="flex items-center justify-center min-w-[44px] min-h-[44px] text-muted-foreground hover:text-foreground transition-colors">
                  <svg aria-hidden="true" className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                  </svg>
                </Link>
                <Link href="https://www.instagram.com/mycure.md/" aria-label="MYCURE on Instagram" className="flex items-center justify-center min-w-[44px] min-h-[44px] text-muted-foreground hover:text-foreground transition-colors">
                  <svg aria-hidden="true" className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <Link href="https://www.linkedin.com/company/mycure" aria-label="MYCURE on LinkedIn" className="flex items-center justify-center min-w-[44px] min-h-[44px] text-muted-foreground hover:text-foreground transition-colors">
                  <svg aria-hidden="true" className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <ul className="-ml-2 text-sm">
                  ...
                  <li>
                    <Link href="/our-story" className="flex items-center min-h-[44px] px-2 text-muted-foreground hover:text-foreground transition-colors">
                      Our Story
                    </Link>
                  </li>
                  <li>
            ...
            <div className="space-y-4">
              ...
              <ul className="-ml-2 text-sm">
                <li>
                  <Link href="https://help.mycure.md/" target="_blank" rel="noopener noreferrer" className="flex items-center min-h-[44px] px-2 text-muted-foreground hover:text-foreground transition-colors">
                    Help Center
                  </Link>
                </li>
                <li>
                  <Link href="mailto:helpdesk@mycure.md" className="flex items-center min-h-[44px] px-2 text-muted-foreground hover:text-foreground transition-colors">
                    Contact
                  </Link>
                </li>
              </ul>
        ...
        <div className="hidden sm:grid sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          ...
          <div className="space-y-4">
            ...
            <ul className="-ml-2 text-sm">
              ...
              <li>
                <Link href="https://portal.mycureapp.com/helpdesk" target="_blank" rel="noopener noreferrer" className="flex items-center min-h-[44px] px-2 text-muted-foreground hover:text-foreground transition-colors">
                  Helpdesk
                </Link>
              </li>
              <li>
                <Link href="https://portal.mycureapp.com/forum" target="_blank" rel="noopener noreferrer" className="flex items-center min-h-[44px] px-2 text-muted-foreground hover:text-foreground transition-colors">
                  Forum
                </Link>
              </li>
            </ul>
