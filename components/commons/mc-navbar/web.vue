<template lang="pug">
  fragment
    //- FIXME: Organize navbar for both providers and patients
    //- mc-covid-banner
    mc-cookie-prompt
    v-app-bar(
      height="70"
      ...
      v-container.pa-0
        v-row(justify="center" align="center" no-gutters)
          ...
          v-btn(
            ...
            span.tab.text-none.font-weight-bold &nbsp;Log In
          v-btn(
            ...
            strong.white--text.tab.text-none Request an Invite
          v-btn(
            width="130"
            ...
            strong.white--text.tab.text-none Book a Demo
          v-btn(
            ...
            strong.white--text.tab.text-none Start 14-Day Trial
          v-btn(
            width="130"
            ...
            strong.white--text.tab.text-none Get Started
          v-btn(
            v-else
            color="accent"
            id="get-started-btn"
            ...
            strong.white--text.tab.text-none Get Started Free
</template>
