...
<script>
import { mdiDoctor, mdiStethoscope, mdiClipboardListOutline, mdiCalendarClock, mdiLaptop, mdiWifiCheck } from '@mdi/js';
...
.blue-grad {
  background: linear-gradient(180deg, #0099CC 0%, #00397B 100%) !important;
