            ...
            v-row(justify="center").mb-5
              v-col(cols="12" md="6" xl="8")
                ...
                v-row(justify="center")
                  v-col(cols="12" md="10")
                    p.mc-metatitle-set-1.font-weight-semibold.primary--text.mb-8.font-open-sans MYCURE provides a wide array of modern healthcare management solutions that are custom-built for doctors, clinics, diagnostic labs and hospitals at a fraction of the cost.
                signup-button(
                  depressed
                  rounded
                  width="228px"
