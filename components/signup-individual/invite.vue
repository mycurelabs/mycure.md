  ...
  v-form(ref="formRef" v-model="valid").content-padding
    v-container
      v-row(justify="center" align="center")
        ...
        v-col(cols="12" md="3" xl="2" align-self="start")
          img(
            v-if="!$isMobile"
          ...
          p(v-if="$isMobile").text-justify Hi! As we continue to make our product the best it can be,&nbsp;
            strong MYCURE virtual clinic is currently by invite only.
            | Fill up the form and we'll reach out to you within 24 hrs if you wish to try it now for free.
          span.float-right.primary--text
            a(@click="referralCodeDialog = true") I have a referral code.
        v-col(cols="12" md="5" xl="4" justify="center" align-self="start")
...
export default {
  data () {
    ...
    return {
      ...
      referralCodeError: 'Invalid referral code. Please try again later.',
      mobileNoError: false,
