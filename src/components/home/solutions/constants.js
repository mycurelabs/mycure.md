...
export const SLIDES = [
  'mycure_home_web_complete_for_clinics_1',
  'mycure_home_web_complete_for_clinics_2',
  'mycure_home_web_complete_for_clinics_3',
  'mycure_home_web_complete_for_clinics_4',
  'mycure_home_web_complete_for_clinics_5',
  'mycure_home_web_complete_for_clinics_6',
  'mycure_home_web_complete_for_clinics_7',
  'mycure_home_web_complete_for_clinics_8',
  'mycure_home_web_complete_for_clinics_9'
];
