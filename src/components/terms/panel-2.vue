    ...
    b-container
      b-row.justify-content-md-center
        b-col(xs="12" md="10").mb-5
          img(width="250" src="../../assets/images/v4/mycure-modules-bread.png" style="position: absolute; left: -250px;").side-img
          p These 
            b Terms and Conditions 
            | ("Terms", "Terms and Conditions") govern your relationship with 
            strong www.mycure.md 
            | website and 
            strong MYCURE 
        ...
        b-col(xs="12" md="10").mb-5.text-center
          h1 Contact Us
          p(style="text-align: center") If you have any questions about these Terms, 
            strong(@click="toggleChat").toggle-chat please contact us
            |.
</template>
