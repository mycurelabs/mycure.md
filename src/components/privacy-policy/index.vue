<template lang="pug">
  div
    ...
    div.pl-5.pr-5.pt-5
      ...
      //- p For DPA Compliance
      p Last updated: March 6, 2018
      strong(style="font-size: 19px;") Privacy Statement
      p MYCURE, Inc. - USA and Team O.P.S. Inc. - Philippines (â€œcompanyâ€, "us", "we", or "our") operate the www.MYCURE.md website and the MYCURE mobile applications (the "Service").
      ...
      p Any sensitive, privileged and personal information that you provide shall be kept protected under the Republic Act No. 10173, or the Data Privacy Act of 2012, and its Implementing Rules and Regulations (collectively, the â€œData Privacy Actâ€).
      p We will not use or share your Personal Information with anyone except as described in this Privacy Policy and in MYCUREâ€™s 
        router-link(:to="{name:'privacy-policy'}") Terms and Conditions.
      ...
      strong(style="font-size: 19px;") Information Collection And Use
      ...
      strong(style="font-size: 19px;") Log Data
      ...
      strong(style="font-size: 19px;") Location information
      ...
      strong(style="font-size: 19px;") Cookies
      ...
      strong(style="font-size: 19px;") DoubleClick Cookie
      ...
      strong(style="font-size: 19px;") Sharing of Personal Information
      ...
      strong(style="font-size: 19px;") Communications
      ...
      strong(style="font-size: 19px;") Compliance With Laws
      p We will disclose your Personal Information where required to do so by law or subpoena or if we believe that such action is necessary to comply with the law and the reasonable requests of law enforcement or to protect the security or integrity of our Service.

      strong(style="font-size: 19px;") Business Transaction
      ...
      strong(style="font-size: 19px;") Storage and Protection of Personal Information
      ...
      strong(style="font-size: 19px;") Retention Period
      ...
      strong(style="font-size: 19px;") International Transfer
      p Your information, including Personal Information, may be transferred to â€” and maintained on â€” computers located outside of your state, province, country or other governmental jurisdiction where the data protection laws may differ than those from your jurisdiction.
      ...
      strong(style="font-size: 19px;") Links To Other Sites
      ...
      strong(style="font-size: 19px;") Children's Privacy
      ...
      strong(style="font-size: 19px;") Your Rights under the Data Privacy Act
      ...
      strong(style="font-size: 19px;") Changes To This Privacy Policy
      ...
      strong(style="font-size: 19px;") Consent
