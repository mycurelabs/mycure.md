    ...
    v-container
      v-layout(row wrap justify-center)
        v-flex(xs12 md10).mb-5
          img(width="250" src="../../assets/images/mycure-modules-bread.png" style="position: absolute; left: -60px;")
          ...
          p We will not use or share your Personal Information with anyone except as described in this Privacy Policy and in MYCURE's 
            router-link(:to="{name:'terms'}").blue--text Terms and Conditions.
        ...
        v-flex(xs12 md10).mb-5
          img(width="550" src="../../assets/images/mycure-modules-plantg.png" style="position: absolute; right: -450px;").side-img
          h2 Consent
