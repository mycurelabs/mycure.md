    ...
    b-container
      b-row.pb-5.pt-5
        div.col-xs-12.col-md-10.offset-md-1
          //- img(src="../../assets/images/v4/mycure-modules-coffee.png" :class="{'animate': scrollTop > 2025}").coffee --> Note: Joff gusto ko sana ilagay sa right side instead of sa left ~ Mark :D
