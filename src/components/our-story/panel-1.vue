...
div
          ...
          v-layout(row justify-center)
            v-flex(xs12 md6)
              v-layout(column align-start)
                h1.font-weight-bold.font-21.font-mc-blue.pb-3.uspMetaTitle MYCURE | Our Story
                h2.title-line-height.font-xl.font-work-sans.pb-4 MYCURE starts and ends with real people.
                v-btn(
                    ...
                    v-card(width="600")
                      v-card-text
                        iframe(
                          align="middle"
                          id="ytplayer" 
                          type="text/html" height="400" width="570"
  ...
  div(v-else)
    v-layout(column wrap justify-center).mt-5
      ...
      h2.font-40.font-work-sans.title-line-height.pb-5.text-xs-center.uspTitle MYCURE starts and ends with real people.
      ...
      v-layout(row justify-center)
        v-btn(
          ...
          strong.font-25.text-none.white--text Watch Video
      v-dialog(v-model="videoDialog" max-width="100%")
        v-layout(row justify-center)
          v-card(width="600")
            v-card-text
              iframe(
                align="middle"
                id="ytplayer" 
                type="text/html" height="175" width="300"
                src="https://www.youtube.com/embed/zvM3LIvq-6k?autoplay=1&loop=1&showinfo=0&rel=0"
                frameborder="0"
                allowfullscreen
            )
