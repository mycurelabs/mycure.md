      ...
      v-layout(row wrap justify-center)
        ...
        v-flex(xs12 md8).px-3
          p(style="text-align: justify").py-3.font-s Meet Paulette, a young widow at 30 years old with two kids (4 yo and 6 yo) in her care. Despite limited resources, she managed to give her kids a good foundation. Paulette is a cancer warrior and survivor. For about a decade and a half now, her life was all about doctor's visits, regular checkups, and staying healthy. 
            ...
            p.font-s Our founder, Dale, was witness to all of this. Paulette is Dale’s mother.
</template>
